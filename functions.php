<?php
/**
 * femmefab functions and definitions
 *
 ...
 */
function femmefab_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on femmefab, use a find and replace
		* to change 'femmefab' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'femmefab', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'femmefab' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'femmefab_custom_background_args',
			array(
 ...
 */
function femmefab_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'femmefab_content_width', 640 );
}
add_action( 'after_setup_theme', 'femmefab_content_width', 0 );
 ...
 */
function femmefab_widgets_init() {
	register_sidebar(
		array(
...
add_action( 'widgets_init', 'femmefab_widgets_init' );
