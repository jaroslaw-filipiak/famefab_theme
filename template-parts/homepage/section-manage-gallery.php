        ...
        <div class="row h-100" style="position: relative">
            ...
            <div class=" col-10 col-md-9 d-flex justify-content-between">
                ...
                <div>
                    ...
                    <div data-scroll data-scroll-speed="1"
                        class="gsap__we-love-to-manage-horizontaly--trigger content-and-arrow d-flex align-items-center justify-content-start p-0">
                ...
                <div data-scroll data-scroll-speed="3"
                    class="manage-gallery--gallery  d-flex flex-column flex-lg-row align-items-center justify-content-center align-items-lg-center justify-content-lg-center"
                    style="width:100%">
                    <div class="manage-gallery-row-1">
                        <div class="manage-gallery--item"
                            style="background-image: url('<?php echo get_theme_file_uri() ?>/dist/assets/img/manage-gallery/gallery-1.png');">
                    ...
                    <div class="manage-gallery-row-2">
                        <div class="manage-gallery--item"
                            style="background-image: url('<?php echo get_theme_file_uri() ?>/dist/assets/img/manage-gallery/gallery-2.png');">
                            <div class="manage-gallery--item--content">emily taylor</div>
                        </div>
                        <div class="manage-gallery--item"
                            style="background-image: url('<?php echo get_theme_file_uri() ?>/dist/assets/img/manage-gallery/gallery-3.png');">
                            <div class="manage-gallery--item--content">emily taylor</div>
                        </div>
                    </div>
                </div>
