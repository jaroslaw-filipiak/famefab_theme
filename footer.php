		...
		<div class="container-fluid">
			<div class="row footer--columns-wrapper d-flex align-items-start justify-content-between">
				...
				<div data-scroll data-scroll-speed="1"
					class=" col-6 col-sm-6 col-lg-3 footer-col-xl-fixed-width d-flex flex-column align-items-start align-items-sm-center align-items-lg-start  justify-content-start ">
				...
				<div data-scroll data-scroll-speed="1"
					class=" col-6 col-sm-6 col-lg-3 footer-col-xl-fixed-width d-flex flex-column align-items-start align-items-sm-center align-items-lg-center  justify-content-start ">
					<div class="footer-col-content">
				...
				<div data-scroll data-scroll-speed="1"
					class=" col-6 col-sm-6 col-lg-3 footer-col-xl-fixed-width d-flex flex-column align-items-start align-items-sm-center align-items-lg-end  justify-content-start ">
					<div class="footer-col-content">
