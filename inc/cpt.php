...
function influencers_post_type() {

	$labels = array(
		'name'                  => _x( 'Influencers', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Influencer', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Influencers', 'text_domain' ),
		'name_admin_bar'        => __( 'Influencers', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
...
add_action( 'init', 'influencers_post_type', 0 );
